...
<section id="contenido">
        <h2>Determinar el estilo de aprendizaje</h2>
        <h3>Yo aprendo...</h3>
        <form name="estilo">
        ...
        <div class="btn-aling">
            <button class="button">Calcular estilo de aprendizaje</button>
        </div>

        <div id="resultado"></div>
</section>
<script type="text/javascript" src="public\js\determinaEstilo.js"></script>
<?php 
